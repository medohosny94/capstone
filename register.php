...
if(isset($_POST['btn-register'])){
    ...
    if(empty($firstname)){
        $error = true;
        $errorUsername = 'Please input firstname';
    }

    if(empty($lastname)){
        $error = true;
        $errorUsername = 'Please input lastname';
    }
    ...
    if(empty($cpassword)) {
        $error = true;
        $errorPassword = 'Please confirm password';
    }
    ...
    if(!$error){
        $sql = "insert into tbl_users(username, firstname, lastname, email ,password)
